...
import 'package:app/rpc/weibo.dart';
...
class GlobalService {
  ...
  late final UserGrpcClient userClient = UserGrpcClient(subject);
  late final UploadClient uploadClient = UploadClient(subject);
  late final MomentGrpcClient momentClient = MomentGrpcClient(subject);
  late final ContentGrpcClient contentClient = ContentGrpcClient(subject);
  late final ActionGrpcClient actionClient = ActionGrpcClient(subject);
  late final WeiboClient weiboClient = WeiboClient();
