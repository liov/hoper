...
import { responsiveStorageNameSpace } from "@/utils/env";
...
export const $t = (key: string,params?: any) => key;

export const i18n: I18n = createI18n({
  legacy: false,
  locale:
    storage.getItem<StorageConfigs>(
...
export const tr = (key: string,params?: any) => i18n.global.t(key,params);
