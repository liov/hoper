<template>
    ...
    <view class="popup-content">
			...
			<uni-popup ref="popup" background-color="#fff">
                <view class="popup-content">
                    <uni-swiper-dot class="uni-swiper-dot-box" :info="previewImgs" :current="current" field="content" mode="round">
                        <swiper style="width: 100%;height: 100%;" @change="change">
                            <swiper-item v-for="(img ,iidx) in previewImgs" :key="iidx">
                                <view class="swiper-item">
                                    <image :src="staticDir+img" mode="aspectFit" style="width: 100vw;height: 100vh;"/>
                                </view>
                            </swiper-item>
                        </swiper>
                    </uni-swiper-dot>
