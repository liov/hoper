...
export default {
    install: (app, options) => {
        app.directive("dateFormat", function (value) {
        ...
        app.config.globalProperties.$customUpload =
            async ({action, data, file, filename, headers, onError, onProgress,
                       onSuccess, withCredentials, classify }) => {
