 ...
 * 注册方法:
 * Register.newUDHolderWithLuaClass(Dialog.LUA_CLASS_NAME, UserdataBridge.class, true)
 * 若想在Java层实现参数自动转换，则增加注册:
 *
 * @see com.immomo.mls.MLSBuilder#registerCovert
 * @see com.immomo.mls.MLSBuilder.CHolder
 * new MLSBuilder.CHolder(UserdataBridge.class)
 */
@LuaClass
public class UserdataBridge {
    /**
     * Lua类型，Lua可由此创建对象:
     * local obj = UserdataBridge()
     */
    public static final String LUA_CLASS_NAME = "UserdataBridge";
    /**
     ...
     * @param g 虚拟机
     */
    //public UserdataBridge(@NonNull Globals g) {}

    /**
     * Lua构造函数，不需要虚拟机及上下文环境
     * @param init 初始化参数
     */
    //public UserdataBridge(@NonNull LuaValue[] init) {}

    /**
     * Lua构造函数，不需要虚拟机，不关心初始化参数
     */
    //public UserdataBridge() {}
    //</editor-fold>
     ...
     */
    public UserdataBridge(@NonNull Globals g, @NonNull LuaValue[] init) {
