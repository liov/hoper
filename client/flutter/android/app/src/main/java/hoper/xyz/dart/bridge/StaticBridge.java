 ...
 * 注册方法：
 * Register.newSHolderWithLuaClass(StaticBridge.LUA_CLASS_NAME, StaticBridge.class)
 */
...
public class StaticBridge {
     ...
     * Lua类名
     */
    public static final String LUA_CLASS_NAME = "StaticBridge";

    //<editor-fold desc="Bridge API">
    /**
     * 直接在属性中增加注解，可让Lua有相关属性
     * eg:
     * StaticBridge:property()      --获取相关值
     * StaticBridge:property(10)    --设置相关值
     */
    @LuaBridge
    static int property;
     ...
     * Lua调用方法：
     * StaticBridge:methodC() --不可使用methodB()调用
     * <p>
     * 参数类型可选择:
     * 0. 虚拟机对象
     * 1. 基本数据类型，及其数组类型
