...
- [zh-Hans.json](file://client/uniapp/src/locale/zh-Hans.json)
...
UA_JSON["en.json / zh-Hans.json<br/>内置语言包"]
end
subgraph "Web 前端"
...
- [zh-Hans.json:1-51](file://client/uniapp/src/locale/zh-Hans.json#L1-L51)
...
- 语言标准化与切换
  - normalizeLocale将“zh”“zh-CN”等映射为“zh-Hans”，保证键名一致性。
...
- 语言文件
  - en.json与zh-Hans.json采用扁平键值结构，便于直接映射。
...
- 回退语言
  - UniApp：fallbackLocale为zh-Hans；translate在无匹配时回退原key。
