...
//go:generate mockgen -destination ../protobuf/user/mock/user.mock.go -package mock github.com/liov/hoper/go/v2/protobuf/user UserServiceServer
import (
	"os/signal"
	"syscall"
