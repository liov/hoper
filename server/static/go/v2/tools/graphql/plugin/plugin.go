		...
		if m := file.GetMessage(typeWithoutPrefix); m != nil {
			...
			if p.IsAny(typeName) {
				p.scalars[typeName] = &Type{ModelDescriptor: ModelDescriptor{
					PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", //TODO generate gqlgen.yml
					TypeName:   ScalarAny,
				}}
				return nil
			}
		...
		if message := p.getMessageType(file, typeName); message != nil {
			...
			for _, field := range message.GetField() {
				...
				if gogoproto.IsCastType(field) {
					...
					switch typ {
					case "int8":
						p.scalars[ScalarInt8] = &Type{ModelDescriptor: ModelDescriptor{PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", TypeName: ScalarInt8}}
					case "uint8":
						p.scalars[ScalarUint8] = &Type{ModelDescriptor: ModelDescriptor{PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", TypeName: ScalarUint8}}
					}
				} else {
					switch *field.Type {
					case descriptor.FieldDescriptorProto_TYPE_BYTES:
						p.scalars[ScalarBytes] = &Type{ModelDescriptor: ModelDescriptor{PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", TypeName: ScalarBytes}}

					case descriptor.FieldDescriptorProto_TYPE_FLOAT:
						p.scalars[ScalarFloat32] = &Type{ModelDescriptor: ModelDescriptor{PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", TypeName: ScalarFloat32}}

					case descriptor.FieldDescriptorProto_TYPE_INT64,
						descriptor.FieldDescriptorProto_TYPE_SINT64,
						descriptor.FieldDescriptorProto_TYPE_SFIXED64:
						p.scalars[ScalarInt64] = &Type{ModelDescriptor: ModelDescriptor{PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", TypeName: ScalarInt64}}

					case descriptor.FieldDescriptorProto_TYPE_INT32,
						descriptor.FieldDescriptorProto_TYPE_SINT32,
						descriptor.FieldDescriptorProto_TYPE_SFIXED32:
						p.scalars[ScalarInt32] = &Type{ModelDescriptor: ModelDescriptor{PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", TypeName: ScalarInt32}}

					case descriptor.FieldDescriptorProto_TYPE_UINT32,
						descriptor.FieldDescriptorProto_TYPE_FIXED32:
						p.scalars[ScalarUint32] = &Type{ModelDescriptor: ModelDescriptor{PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", TypeName: ScalarUint32}}

					case descriptor.FieldDescriptorProto_TYPE_UINT64,
						descriptor.FieldDescriptorProto_TYPE_FIXED64:
						p.scalars[ScalarUint64] = &Type{ModelDescriptor: ModelDescriptor{PackageDir: "github.com/liov/hoper/go/v2/utils/net/http/api/graphql", TypeName: ScalarUint64}}
					}
				}
