...
autobind:
  - "github.com/liov/hoper/server/go/protobuf/{{.}}"
...
models:
  ID:
    model:
      - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.UInt64
  Int:
    model:
  ...
  Uint8:
    model:
      - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.Uint8
  Uint:
    model:
      - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.Uint
  Uint32:
      model:
        - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.Uint32
  Uint64:
      model:
        - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.Uint64
  Float32:
    model:
      - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.Float32
  Float64:
    model:
      - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.Float64
  Float:
    model:
      - github.com/99designs/gqlgen/graphql.Float
  Bytes:
    model:
      - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.Bytes
  HttpResponse_HeaderEntry:
    model:
      - github.com/liov/hoper/server/go/lib/utils/net/http/api/graphql.HttpResponse_HeaderEntry
`
