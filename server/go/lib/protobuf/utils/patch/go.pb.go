...
func (x *Options) Reset() {
	*x = Options{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utils_patch_go_proto_msgTypes[0]
...
func (*Options) Descriptor() ([]byte, []int) {
	return file_utils_patch_go_proto_rawDescGZIP(), []int{0}
}
...
func (x *FileOptions) Reset() {
	*x = FileOptions{}
	if protoimpl.UnsafeEnabled {
		mi := &file_utils_patch_go_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FileOptions) Descriptor() ([]byte, []int) {
	return file_utils_patch_go_proto_rawDescGZIP(), []int{1}
}
...
var file_utils_patch_go_proto_extTypes = []protoimpl.ExtensionInfo{
	{
...
var (
	...
	E_Message = &file_utils_patch_go_proto_extTypes[0]
)

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional go.Options field = 7002;
	E_Field = &file_utils_patch_go_proto_extTypes[1]
)

// Extension fields to descriptorpb.OneofOptions.
var (
	// optional go.Options oneof = 7001;
	E_Oneof = &file_utils_patch_go_proto_extTypes[2]
)

// Extension fields to descriptorpb.EnumOptions.
var (
	// optional go.Options enum = 7002;
	E_Enum = &file_utils_patch_go_proto_extTypes[3]
	// optional string cn = 7003;
	E_Cn = &file_utils_patch_go_proto_extTypes[4]
)

// Extension fields to descriptorpb.EnumValueOptions.
var (
	// optional go.Options value = 7002;
	E_Value = &file_utils_patch_go_proto_extTypes[5]
)

// Extension fields to descriptorpb.FileOptions.
var (
	// optional go.FileOptions file = 7002;
	E_File = &file_utils_patch_go_proto_extTypes[6]
)

var File_utils_patch_go_proto protoreflect.FileDescriptor

var file_utils_patch_go_proto_rawDesc = []byte{
	0x0a, 0x14, 0x75, 0x74, 0x69, 0x6c, 0x73, 0x2f, 0x70, 0x61, 0x74, 0x63, 0x68, 0x2f, 0x67, 0x6f,
	...
	0x6e, 0x73, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x63, 0x74, 0x6c, 0x69, 0x62, 0x6f, 0x79, 0x2f,
	0x68, 0x6f, 0x70, 0x65, 0x72, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x67, 0x6f, 0x2f,
	0x6c, 0x69, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x75, 0x74, 0x69,
	0x6c, 0x73, 0x2f, 0x70, 0x61, 0x74, 0x63, 0x68,
}

var (
	file_utils_patch_go_proto_rawDescOnce sync.Once
	file_utils_patch_go_proto_rawDescData = file_utils_patch_go_proto_rawDesc
)

func file_utils_patch_go_proto_rawDescGZIP() []byte {
	file_utils_patch_go_proto_rawDescOnce.Do(func() {
		file_utils_patch_go_proto_rawDescData = protoimpl.X.CompressGZIP(file_utils_patch_go_proto_rawDescData)
	})
	return file_utils_patch_go_proto_rawDescData
}

var file_utils_patch_go_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_utils_patch_go_proto_goTypes = []interface{}{
...
var file_utils_patch_go_proto_depIdxs = []int32{
...
func init() { file_utils_patch_go_proto_init() }
func file_utils_patch_go_proto_init() {
	if File_utils_patch_go_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_utils_patch_go_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_utils_patch_go_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_utils_patch_go_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 7,
			NumServices:   0,
		},
		GoTypes:           file_utils_patch_go_proto_goTypes,
		DependencyIndexes: file_utils_patch_go_proto_depIdxs,
		MessageInfos:      file_utils_patch_go_proto_msgTypes,
		ExtensionInfos:    file_utils_patch_go_proto_extTypes,
	}.Build()
	File_utils_patch_go_proto = out.File
	file_utils_patch_go_proto_rawDesc = nil
	file_utils_patch_go_proto_goTypes = nil
	file_utils_patch_go_proto_depIdxs = nil
}
