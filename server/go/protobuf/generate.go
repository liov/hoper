...
import (
	...
	"github.com/liov/hoper/v2/utils/os"
	execi "github.com/liov/hoper/v2/utils/os/exec"
)
...
autobind:
  - "github.com/liov/hoper/v2/protobuf/{{.}}"
  - "github.com/liov/hoper/v2/protobuf/utils/response"
  - "github.com/liov/hoper/v2/protobuf/utils/oauth"

models:
  ID:
    model:
      - github.com/liov/hoper/v2/utils/net/http/api/graphql.UInt64
  Int:
    model:
  ...
  Uint8:
    model:
      - github.com/liov/hoper/v2/utils/net/http/api/graphql.Uint8
  Uint:
    model:
      - github.com/liov/hoper/v2/utils/net/http/api/graphql.Uint
  Uint32:
      model:
        - github.com/liov/hoper/v2/utils/net/http/api/graphql.Uint32
  Uint64:
      model:
        - github.com/liov/hoper/v2/utils/net/http/api/graphql.Uint64
  Float32:
    model:
      - github.com/liov/hoper/v2/utils/net/http/api/graphql.Float32
  Float64:
    model:
      - github.com/liov/hoper/v2/utils/net/http/api/graphql.Float64
  Float:
    model:
      - github.com/99designs/gqlgen/graphql.Float
  Bytes:
    model:
      - github.com/liov/hoper/v2/utils/net/http/api/graphql.Bytes
  HttpResponse_HeaderEntry:
    model:
      - github.com/liov/hoper/v2/utils/net/http/api/graphql.HttpResponse_HeaderEntry
`
